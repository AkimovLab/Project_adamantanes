...
from recipes import dish_nbra, fssh_nbra, fssh2_nbra, gfsh_nbra, ida_nbra, mash_nbra, msdm_nbra,idf_nbra

#from recipes import dish_rev2023_nbra, dish_rev2023_gfsh_nbra, ida_gfssh_nbra, ida_nbra, idf_nbra, msdm_gfsh_nbra, msdm_nbra

#from matplotlib.mlab import griddata
#%matplotlib inline 
warnings.filterwarnings('ignore')
path_to_save_sd_Hvibs = '../../step33_nthree_B3LYP_new'
istep = 8200    # the first timestep to read
fstep = 11200 # the last timestep to read
nsteps = fstep - istep
NSTEPS = nsteps
...
#############
NSTEPS = (fstep-istep)
dyn_general = { "nsteps":NSTEPS*10, "ntraj":500, "nstates":NSTATES, "dt":1.0*units.fs2au,                                                 
                ...
                "prefix":F"NBRA", "prefix2":F"NBRA", "isNBRA":0,"nfiles": nsteps-1,"maxstep":1000

              }
#"nfiles": nsteps-1,"maxstep":950
...
if prf=="MASH":
    ...
    istates[istate] = 1.0
    elec_params.update( {"init_type":4,  "rep":1,  "istate":10, "istates":istates } )  # different initialization for MASH
def function1(icond):
