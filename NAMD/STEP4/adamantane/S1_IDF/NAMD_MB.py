...
path_to_save_sd_Hvibs = '../../step33three_B3LYP'
istep = 5900    # the first timestep to read
fstep = 8900 # the last timestep to read
nsteps = fstep - istep
NSTEPS = nsteps
...
#############
NSTEPS = (fstep-istep)
dyn_general = { "nsteps":NSTEPS*10, "ntraj":1000, "nstates":NSTATES, "dt":1.0*units.fs2au,                                                 
